 ...
 *
 */
public class FetchRecommendationPreviewListServlet extends HttpServlet {
	//String target = "showOption.jsp";

	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		
		System.out.println("FetchRecommendationPreviewListvRequest from app received");
		...
		*/
		...
		List<RecipePreviewImplementation>  recommendationPreviewList= dbServer.recommendPreview();
		/*
		RecipeInterface recipe = dbServer.fetchRecipe("1");
		if(recipe!=null)
			out.print(gson.toJson(recipe));
		*/
		if(recommendationPreviewList!=null){
			System.out.println("Now list sent back");
			out.print(gson.toJson(recommendationPreviewList));
		}
		else{
			out.print("No record...");
		}
